...
const services = [
  ...
  { name: "Insect Control", slug: "insect-control" },
  { name: "Bed Bug Treatment", slug: "bed-bug-treatment" },
  { name: "Bird Proofing", slug: "bird-proofing" },
  { name: "Fumigation", slug: "fumigation" },
  { name: "Disinfection", slug: "disinfection" },
];
...
const pests = [
  ...
  { name: "Wasps", slug: "wasps" },
  { name: "Moths", slug: "moths" },
];
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-10 mb-12">
          <div className="col-span-2 lg:col-span-1 text-center sm:text-left">
            <h3 className="font-display text-xl sm:text-2xl font-bold mb-3 text-accent-foreground flex items-center justify-center sm:justify-start gap-1">
              <span className="text-primary">Environ</span> Pest Control
            </h3>
            <p className="text-sm leading-relaxed text-accent-foreground/40">
              Professional pest control in London. Protecting homes and businesses since 2010.
            </p>
          </div>
          <div>
            <h4 className="font-body font-semibold mb-4 text-accent-foreground/70 text-xs uppercase tracking-widest">Services</h4>
            <ul className="space-y-2">
              {services.map((s) => (
                <li key={s.slug}>
                  <Link to={`/services/${s.slug}`} className="text-sm text-accent-foreground/35 hover:text-primary transition-colors">{s.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          <div className="pl-4 sm:pl-6 lg:pl-0">
            <h4 className="font-body font-semibold mb-4 text-accent-foreground/70 text-xs uppercase tracking-widest">Pests</h4>
            <ul className="space-y-2">
              {pests.map((p) => (
                <li key={p.slug}>
                  <Link to={`/pests/${p.slug}`} className="text-sm text-accent-foreground/35 hover:text-primary transition-colors">{p.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          <div className="col-span-2 lg:col-span-1 sm:text-left">
            <h4 className="font-body font-semibold mb-4 text-accent-foreground/70 text-xs uppercase tracking-widest text-center sm:text-left">Contact</h4>
            <ul className="space-y-3 sm:space-y-2.5">
              <li className="flex items-center justify-center sm:justify-start gap-3 sm:gap-2.5 text-sm text-accent-foreground/60">
                ...
                <a href="tel:+442038758225" className="hover:text-primary transition-colors">020 3875 8225</a>
              </li>
              <li className="flex items-center justify-center sm:justify-start gap-3 sm:gap-2.5 text-sm text-accent-foreground/60">
                ...
                <a href="https://wa.me/442038758225" className="hover:text-primary transition-colors">WhatsApp</a>
              </li>
              <li className="flex items-center justify-center sm:justify-start gap-3 sm:gap-2.5 text-sm text-accent-foreground/60">
                <Mail className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-primary shrink-0" />
                <a href="mailto:info@environpestcontrol.co.uk" className="hover:text-primary transition-colors">info@environpestcontrol.co.uk</a>
              </li>
              <li className="flex items-start justify-center sm:justify-start gap-3 sm:gap-2.5 text-sm text-accent-foreground/60">
                ...
                <span className="text-left text-sm">Unit 12A, 39 Parsons Green Ln<br/>London SW6 4HH</span>
              </li>
              <li className="flex items-center justify-center sm:justify-start gap-3 sm:gap-2.5 text-sm text-accent-foreground/60">
