...
const BookingForm = () => {
  ...
  return (
    <section id="reservar" className="py-28 relative bg-muted/50">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl font-black mb-6">
              Tu tranquilidad
              <br />
              <span className="text-gradient-primary italic">comienza aquí.</span>
            </h2>
          ...
          >
            <div className="bg-card border border-border rounded-3xl p-8 shadow-cinematic">
              ...
              <button
                className="w-full inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full font-body font-semibold text-base shadow-glow hover:shadow-glow-strong hover:brightness-110 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                disabled={!selected}
              >
